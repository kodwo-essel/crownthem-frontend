...
export default function EventCard() {
  return (
    <div>
      <Card className="group w-80 p-0 rounded-2xl border-gray-50 shadow-sm overflow-hidden transform transition-shadow duration-500 ease-in-out hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)] bg-white">
